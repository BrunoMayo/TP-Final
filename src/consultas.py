...
def saldo(saldo_pesos, saldo_soles, moneda, opcion):
    ...
    """
    if moneda == 1:#Si se eligen pesos
        if opcion == 1: #Si se eligen pesos e imptimir por pantalla
            print(f"El saldo de la cuenta es de {saldo_pesos} pesos") #Se imprime el saldo en pesos por pantalla
        elif opcion == 2:#Si se elige imprimier el saldo en el archivo
            ...
            pass
    elif moneda == 2:#Si se eligen soles
        if opcion == 1: #Si se elige imprimir por pantalla 
...
def movimientos(moneda, opcion):
    ...
    if moneda == 1:
        if opcion == 1: #Si se eligen pesos y visualizar por pantalla
            indice = 0
        ...
        if opcion == 1: #Si se eligen soles e imprimir por pantalla
            indice = 0
            while indice < 5: #Se generan e imprimen por pantalla 5 depositos y 5 transferencias aleatorias en soles
                ...
                indice = indice + 1
        elif opcion == 2: #Si se eligen pesos e imprimir en archivo
            indice = 0
